...
p1 <- ggplot(data=test, aes(x=recovery_rate)) + geom_histogram(fill='steelblue', color='black') + ggtitle('True distribution')
p2 <- ggplot(data=test, aes(x=recovery_rate_hat_final)) + geom_histogram(fill='salmon1', color='black') + ggtitle('Predicted distribution')
