...
#d <- fread('data/loan_data_2007_2014.csv')
...
train <- loan_default_data[issue_d_formated < zoo::as.yearmon('2016-01')]
test <- loan_default_data[issue_d_formated >= zoo::as.yearmon('2016-01')]
