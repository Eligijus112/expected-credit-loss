...
We will split the data into a 75% - 25% train and test data split.
...
train <- d[issue_d_formated < zoo::as.yearmon('2018-01'), ..final_cols]
test <- d[issue_d_formated >= zoo::as.yearmon('2018-01'), ..final_cols]
...
# Saving the data for LGD and EAD 
train <- loan_default_data[issue_d_formated < zoo::as.yearmon('2018-01')]
test <- loan_default_data[issue_d_formated >= zoo::as.yearmon('2018-01')]

# Saving the data for PD  
write.csv(na.omit(train), 'data/train_defaults.csv', row.names=FALSE)
write.csv(na.omit(test), 'data/test_defaults.csv', row.names=FALSE)
```
